package me.jaime29010.alternativedeath.v1_9_R1;
...
public class BodyHelper extends AbstractBodyHelper {
    ...
    public void sendBody(Player player, Location location) {
        ...
        PacketPlayOutPlayerInfo.PlayerInfoData data = packetInfo.new PlayerInfoData(profile, 0, WorldSettings.EnumGamemode.SURVIVAL, null);
